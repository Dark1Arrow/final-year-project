...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full h-[600px] md:h-[700px] bg-gray-600 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#0000009e] opacity-30"></div>

      <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex items-center">
        <div className="text-white max-w-xl">

          <h1 className="text-4xl sm:text-5xl md:text-5xl font-bold leading-tight mb-4">
            Your Next Home,
            <br />
            Secured by Blockchain
          </h1>

          <p className="text-lg sm:text-lg font-light mb-8">
